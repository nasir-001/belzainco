<template>
  <div class="tw-mx-0">
    <div class="md:tw-flex tw-justify-between tw-w-5/6 tw-mx-auto tw-mt-14 md:tw-mt-10">
      <div class="tw-uppercase md:tw-w-1/2 tw-text-gray-800 md:tw-tracking-wide tw-font-serif tw-text-center md:tw-text-left tw-text-4xl tw-font-thin md:tw-text-7xl">
